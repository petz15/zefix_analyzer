...
_TFIDF_STOPWORDS: set[str] = {
    ...
    # Manually added common words that don't help distinguish clusters
    "ausland", "tätigen", "kann", "veräussern", "tochtergesellschaften", 
    "tochtergesellschaft", "beteiligungen", "beteiligen", "verbundenen unternehmen",
    "im ausland", "Geschäfte", "Geschäftstätigkeit", "geschäftstätigkeit", "geschäftstätigkeiten",
    "Zweigniederlassungen", "Zweigniederlassung", "niederlassungen", "niederlassung",
    "Zusammenhang", "Gesellschaft", "gesellschaften", "gesellschafts", "konzern", "konzerne", "gruppe", "gruppen",
